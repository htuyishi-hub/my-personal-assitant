...
export function escapeAllAbleArtifactTags(input: string) {
...
export function escapeAllAbleAActionTags(input: string) {
  // Regular expression to match boltArtifact tags and their content
...
export function escapeAllAbleTags(input: string) {
  return escapeAllAbleArtifactTags(escapeAllAbleAActionTags(input));
}
