import type { ActionType, AllAbleAction, AllAbleActionData, FileAction, ShellAction, SupabaseAction } from '~/types/actions';
import type { AllAbleArtifactData } from '~/types/artifact';
...
export interface ArtifactCallbackData extends AllAbleArtifactData {
  messageId: string;
  artifactId?: string;
}
...
interface MessageState {
  ...
  currentArtifact?: AllAbleArtifactData;
  currentAction: AllAbleActionData;
  actionId: number;
}
        ...
        if (state.insideAction) {
          ...
          if (closeIndex !== -1) {
            ...
            this._options.callbacks?.onActionClose?.({
              ...
              action: currentAction as AllAbleAction,
            });
          ...
          if (actionOpenIndex !== -1 && (artifactCloseIndex === -1 || actionOpenIndex < artifactCloseIndex)) {
            ...
            if (actionEndIndex !== -1) {
              ...
              this._options.callbacks?.onActionOpen?.({
                ...
                action: state.currentAction as AllAbleAction,
              });
