            ...
            if (startingIdx > 0) {
              ...
              filteredMessages = [
                ...
                },
                {
                  ...
                  content: `AllAble Restored your chat from a snapshot. You can revert this message to load the full chat history.
...
${value.content}
            ...
            chatMetadata.set(storedMessages.metadata);
              ...
              // No stored messages for this chat id — do not redirect to root.
              // Treat this as a new empty chat so users can start typing immediately.
              setInitialMessages([]);
              setUrlId(undefined);
              chatId.set(undefined);
              description.set(undefined);
              chatMetadata.set(undefined);
              // ready will be set below
            }
