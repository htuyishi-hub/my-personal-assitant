...
import baseStyles from './BaseChat.module.scss';
import artStyles from './ChatBox.module.scss';
  ...
  return (
    <div
      ...
      className={classNames(
        ...
        artStyles.chatBoxArt,
        // keep original border for structure
    ...
    >
      <svg className={classNames(baseStyles.PromptEffectContainer)}>
        <defs>
          <linearGradient
            id="line-gradient"
            x1="20%"
        ...
        <rect className={classNames(baseStyles.PromptEffectLine)} pathLength="100" strokeLinecap="round"></rect>
        <rect className={classNames(baseStyles.PromptShine)} x="48" y="24" width="70" height="1"></rect>
      </svg>
      <div>
        <ClientOnly>
          {() => (
      ...
      >
        ...
        <div
          className={classNames(
            artStyles.chatCorners,
            artStyles.cornerTopLeft,
            activeCorner === 'top-left' && 'scale-125 bg-accent-500',
          )}
        >
          <div className="i-ph:arrow-up-left" />
        </div>
        <div
          className={classNames(
            artStyles.chatCorners,
            artStyles.cornerTopRight,
            activeCorner === 'top-right' && 'scale-125 bg-accent-500',
          )}
        >
        ...
        <div
          className={classNames(
            artStyles.chatCorners,
            artStyles.cornerBottomLeft,
            activeCorner === 'bottom-left' && 'scale-125 bg-accent-500',
          )}
        >
          <div className="i-ph:arrow-down-left" />
        </div>
        <div
          className={classNames(
            artStyles.chatCorners,
            artStyles.cornerBottomRight,
            activeCorner === 'bottom-right' && 'scale-125 bg-accent-500',
          )}
        >
          <div className="i-ph:arrow-down-right" />
        </div>
        ...
        <textarea
          ...
          className={classNames(
            'w-full pl-4 pt-4 pr-16 outline-none resize-none text-white placeholder-white bg-transparent font-bold',
            'transition-all duration-200',
            'hover:border-bolt-elements-focus',
            artStyles.chatTextarea,
          )}
          onDragEnter={(e) => {
            e.preventDefault();
          ...
          placeholder={props.chatMode === 'build' ? 'How can AllAble help you today?' : 'What would you like to discuss?'}
          translate="no"
        />
        <ClientOnly>
          {() => (
