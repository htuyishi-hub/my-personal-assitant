...
export const ChatImpl = memo(
  ({ description, initialMessages, storeMessageHistory, importChat, exportChat }: ChatProps) => {
    ...
    // if the user just finished onboarding, show a quick toast and clear the query
    useEffect(() => {
      if (searchParams.get('onboard') === '1') {
        toast.success(`Welcome! Provider: ${provider.name}`);
        // remove param to avoid repeating
        setSearchParams({});
      }
    }, [searchParams, setSearchParams, provider]);
